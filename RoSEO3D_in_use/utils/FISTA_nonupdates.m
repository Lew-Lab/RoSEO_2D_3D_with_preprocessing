function [gammanew_out,loc_re_new_out,NLL_cur_out] = FISTA_nonupdates(SMLM_img_re,b,gammaold,loc_re_old,rx,rz,G_re,MaxIt,Lmax,imgPara)
...
%f_loss = @(Iobs,Iest) sum((Iobs-Iest).^2./sqrt(Iest));
...
%      gradient_cur(1:6)=0;    
 %     end
    ...
    %[G_re,loc_re_new,gammanew] = update_basisMatrix(N,gammanew,loc_re_old,imgPara);
