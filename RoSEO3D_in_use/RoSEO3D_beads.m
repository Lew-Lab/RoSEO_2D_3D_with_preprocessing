...
function [SM_est,NLL_cur_out,gamma_est] = RoSEO3D_beads(SMLM_img, b, n1,FPSFx, FPSFy, imgPara,imgPara_B, varargin)
gamma_est = [];
...
[gamma_est,loc_rec_est,~] = FIST_optimize_step2_v2(gamma_est,loc_rec_est,reshape(SMLM_img,[],1),reshape(b,[],1),imgPara, imgPara_B);
NLL_cur_out=NLL_save;
