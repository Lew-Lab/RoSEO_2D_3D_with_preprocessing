...
source_dir = 'F:\data\20210209lipid membrane\offset_subtracted_data\data30\'; % directory containing required data
img_stack_name = 'data30'; %name of the image stack to be analyzed (add .bin)
backg_stack_name = 'BGEst_lineFitWavelet\data30_BKG'; %name of the background stack (add .bin)
