function[gammaf, recovStruct, loc_data] = RoSEO(obj, SMLM_img, b, FPSFx, FPSFy, thred, varargin)
...
%===========================
[GradMap, gammhat2] = grad_map3_TW(reshape(gammahat1, 12 * n_grid_p, subframe_l * (n_sub_frame + 1)), ...
    thred,recovStruct);
if ~any(gammhat2)
    gammaf = [];
    loc_data = [];
