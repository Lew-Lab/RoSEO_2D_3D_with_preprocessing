% TW modified based on Hesam's original grad_map2; using absolution
% threshold, instead of relative threshold

function [grad_map_avg, gammaf] = grad_map3_TW(gammahat, thred, recovStruct)
...
for i = 1:n_frames
    ...
    if any(z_secondMoments(:) > 0)
        ...
        grad_map_avg_t = grad_map_avg_t /thred; % so that the most likely grid point has value of 1
