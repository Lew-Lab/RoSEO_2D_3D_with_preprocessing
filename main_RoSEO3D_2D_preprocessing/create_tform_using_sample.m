...
%prepare data
pixel_sz = 1;
photonThred = 200; % in photon for y channel
frame_thred = 2000;
ratio_y2x = 1;

center = [351,162]; %in pixel; directly get from the y channel image where the sample is located; have not flip the data
center(1) = W-center(1);
ROI = 250;
